ALTER TABLE public.post_metrics_raw
  ADD CONSTRAINT post_metrics_raw_post_id_fkey
  FOREIGN KEY (post_id) REFERENCES public.posts(id) ON DELETE CASCADE;

DROP POLICY IF EXISTS "Service role manages post metrics" ON public.post_metrics_raw;

CREATE POLICY "Backend manages post metrics"
