...
export const FORMAT_TOOLTIPS: Record<string, string> = {
  ...
  instagram_story_link: "Story vertical com link sticker, máx. 60 segundos",
  linkedin_post: "Texto com imagens ou vídeo opcional (vídeo até 10 min)",
  linkedin_document: "PDF com múltiplas páginas (carrossel, até 300 págs / 100MB)",
  youtube_shorts: "Vídeo vertical, 9:16, máx. 60 segundos",
  youtube_video: "Vídeo horizontal, 16:9. Canais não verificados: máx. 15 min",
  tiktok_video: "Vídeo vertical, 9:16, entre 3 segundos e 10 minutos",
  facebook_image: "Imagem (≤4MB recomendado) ou vídeo, várias proporções suportadas",
  facebook_stories: "Imagem ou vídeo vertical, 9:16, máx. 2 minutos",
  facebook_reel: "Vídeo vertical, 9:16, máx. 90 segundos",
  googlebusiness_post: "Apenas imagem (máx. 5MB, mín. 400×300px). Vídeo não suportado pela API.",
};
