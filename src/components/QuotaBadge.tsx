      ...
      <div className="flex items-center gap-1 sm:gap-2 px-1.5 sm:px-3 py-1 sm:py-2 rounded-lg bg-muted/50 border border-border">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className={cn(
              'flex items-center gap-1 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-md transition-all duration-300 border',
              getStatusClasses(instagram.status)
            )}>
              <Instagram className="h-3 w-3 sm:h-3.5 sm:w-3.5" />
              <span className="text-[10px] sm:text-xs font-semibold tabular-nums">{instagram.quotaText}</span>
            </div>
          </TooltipTrigger>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <div className={cn(
              ...
              <span className="text-[10px] sm:text-xs font-semibold tabular-nums">{linkedin.quotaText}</span>
            </div>
          </TooltipTrigger>
          <TooltipContent side="bottom" className="max-w-xs">
            <div className="text-xs space-y-2">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className={cn(
                'p-1 sm:p-1.5 rounded-md transition-colors hidden sm:block',
